...
{
public:
  explicit Init_InverseKin_Response_res(::dobot_msgs_v4::srv::InverseKin_Response & msg)
  : msg_(msg)
  {}
...
class Init_InverseKin_Response_robot_return
{
public:
  Init_InverseKin_Response_robot_return()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_InverseKin_Response_res robot_return(::dobot_msgs_v4::srv::InverseKin_Response::_robot_return_type arg)
  {
    msg_.robot_return = std::move(arg);
    return Init_InverseKin_Response_res(msg_);
  }
...
{
  return dobot_msgs_v4::srv::builder::Init_InverseKin_Response_robot_return();
}
...
class Init_InverseKin_Event_response
{
public:
  explicit Init_InverseKin_Event_response(::dobot_msgs_v4::srv::InverseKin_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs_v4::srv::InverseKin_Event response(::dobot_msgs_v4::srv::InverseKin_Event::_response_type arg)
  {
...
private:
  ::dobot_msgs_v4::srv::InverseKin_Event msg_;
};

class Init_InverseKin_Event_request
{
public:
  explicit Init_InverseKin_Event_request(::dobot_msgs_v4::srv::InverseKin_Event & msg)
  : msg_(msg)
  {}
  Init_InverseKin_Event_response request(::dobot_msgs_v4::srv::InverseKin_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_InverseKin_Event_response(msg_);
  }
...
class Init_InverseKin_Event_info
{
public:
  Init_InverseKin_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_InverseKin_Event_request info(::dobot_msgs_v4::srv::InverseKin_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_InverseKin_Event_request(msg_);
  }
...
template<>
inline
auto build<::dobot_msgs_v4::srv::InverseKin_Event>()
{
  return dobot_msgs_v4::srv::builder::Init_InverseKin_Event_info();
}

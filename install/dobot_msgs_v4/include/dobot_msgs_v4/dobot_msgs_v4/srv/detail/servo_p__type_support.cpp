...
void ServoP_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) dobot_msgs_v4::srv::ServoP_Event(_init);
}

void ServoP_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_msgs_v4::srv::ServoP_Event *>(message_memory);
  typed_message->~ServoP_Event();
}

size_t size_function__ServoP_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<dobot_msgs_v4::srv::ServoP_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ServoP_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<dobot_msgs_v4::srv::ServoP_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__ServoP_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<dobot_msgs_v4::srv::ServoP_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__ServoP_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const dobot_msgs_v4::srv::ServoP_Request *>(
    get_const_function__ServoP_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<dobot_msgs_v4::srv::ServoP_Request *>(untyped_value);
  value = item;
}

void assign_function__ServoP_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<dobot_msgs_v4::srv::ServoP_Request *>(
    get_function__ServoP_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const dobot_msgs_v4::srv::ServoP_Request *>(untyped_value);
  item = value;
}

void resize_function__ServoP_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<dobot_msgs_v4::srv::ServoP_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__ServoP_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<dobot_msgs_v4::srv::ServoP_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ServoP_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<dobot_msgs_v4::srv::ServoP_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__ServoP_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<dobot_msgs_v4::srv::ServoP_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__ServoP_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const dobot_msgs_v4::srv::ServoP_Response *>(
    get_const_function__ServoP_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<dobot_msgs_v4::srv::ServoP_Response *>(untyped_value);
  value = item;
}

void assign_function__ServoP_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<dobot_msgs_v4::srv::ServoP_Response *>(
    get_function__ServoP_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const dobot_msgs_v4::srv::ServoP_Response *>(untyped_value);
  item = value;
}

void resize_function__ServoP_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<dobot_msgs_v4::srv::ServoP_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoP_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_msgs_v4::srv::ServoP_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(dobot_msgs_v4::srv::ServoP_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__ServoP_Event__request,  // size() function pointer
    get_const_function__ServoP_Event__request,  // get_const(index) function pointer
    get_function__ServoP_Event__request,  // get(index) function pointer
    fetch_function__ServoP_Event__request,  // fetch(index, &value) function pointer
    assign_function__ServoP_Event__request,  // assign(index, value) function pointer
    resize_function__ServoP_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(dobot_msgs_v4::srv::ServoP_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__ServoP_Event__response,  // size() function pointer
    get_const_function__ServoP_Event__response,  // get_const(index) function pointer
    get_function__ServoP_Event__response,  // get(index) function pointer
    fetch_function__ServoP_Event__response,  // fetch(index, &value) function pointer
    assign_function__ServoP_Event__response,  // assign(index, value) function pointer
    resize_function__ServoP_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServoP_Event_message_members = {
  "dobot_msgs_v4::srv",  // message namespace
  "ServoP_Event",  // message name
  3,  // number of fields
  sizeof(dobot_msgs_v4::srv::ServoP_Event),
  false,  // has_any_key_member_
  ServoP_Event_message_member_array,  // message members
  ServoP_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  ServoP_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t ServoP_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &ServoP_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Event>()
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::ServoP_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, ServoP_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::ServoP_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ServoP_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::ServoP_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<dobot_msgs_v4::srv::ServoP>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<dobot_msgs_v4::srv::ServoP>,
...
get_service_type_support_handle<dobot_msgs_v4::srv::ServoP>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::dobot_msgs_v4::srv::ServoP_Event
      >()->data
      );
  }

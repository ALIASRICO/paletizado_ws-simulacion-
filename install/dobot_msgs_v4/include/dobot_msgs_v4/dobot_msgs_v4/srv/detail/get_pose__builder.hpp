...
{
public:
  explicit Init_GetPose_Event_response(::dobot_msgs_v4::srv::GetPose_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs_v4::srv::GetPose_Event response(::dobot_msgs_v4::srv::GetPose_Event::_response_type arg)
  {
...
private:
  ::dobot_msgs_v4::srv::GetPose_Event msg_;
};

class Init_GetPose_Event_request
{
public:
  explicit Init_GetPose_Event_request(::dobot_msgs_v4::srv::GetPose_Event & msg)
  : msg_(msg)
  {}
  Init_GetPose_Event_response request(::dobot_msgs_v4::srv::GetPose_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetPose_Event_request info(::dobot_msgs_v4::srv::GetPose_Event::_info_type arg)
  {
...
template<>
inline
auto build<::dobot_msgs_v4::srv::GetPose_Event>()
{
  return dobot_msgs_v4::srv::builder::Init_GetPose_Event_info();
}

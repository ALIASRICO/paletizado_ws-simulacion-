...
{
  new (message_memory) dobot_msgs_v4::srv::EmergencyStop_Request(_init);
}

void EmergencyStop_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_msgs_v4::srv::EmergencyStop_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencyStop_Request_message_member_array[1] = {
  {
    ...
    offsetof(dobot_msgs_v4::srv::EmergencyStop_Request, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencyStop_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(dobot_msgs_v4::srv::EmergencyStop_Request),
...
get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Request>()
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, EmergencyStop_Request)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Request_message_type_support_handle;
}
...
void EmergencyStop_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) dobot_msgs_v4::srv::EmergencyStop_Response(_init);
}

void EmergencyStop_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_msgs_v4::srv::EmergencyStop_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencyStop_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_msgs_v4::srv::EmergencyStop_Response, res),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencyStop_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(dobot_msgs_v4::srv::EmergencyStop_Response),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Response>()
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, EmergencyStop_Response)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Response_message_type_support_handle;
}
...
void EmergencyStop_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) dobot_msgs_v4::srv::EmergencyStop_Event(_init);
}

void EmergencyStop_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_msgs_v4::srv::EmergencyStop_Event *>(message_memory);
  typed_message->~EmergencyStop_Event();
}

size_t size_function__EmergencyStop_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<dobot_msgs_v4::srv::EmergencyStop_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<dobot_msgs_v4::srv::EmergencyStop_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<dobot_msgs_v4::srv::EmergencyStop_Request> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const dobot_msgs_v4::srv::EmergencyStop_Request *>(
    get_const_function__EmergencyStop_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<dobot_msgs_v4::srv::EmergencyStop_Request *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<dobot_msgs_v4::srv::EmergencyStop_Request *>(
    get_function__EmergencyStop_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const dobot_msgs_v4::srv::EmergencyStop_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<dobot_msgs_v4::srv::EmergencyStop_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<dobot_msgs_v4::srv::EmergencyStop_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<dobot_msgs_v4::srv::EmergencyStop_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__EmergencyStop_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const dobot_msgs_v4::srv::EmergencyStop_Response *>(
    get_const_function__EmergencyStop_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<dobot_msgs_v4::srv::EmergencyStop_Response *>(untyped_value);
  value = item;
}
...
void assign_function__EmergencyStop_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<dobot_msgs_v4::srv::EmergencyStop_Response *>(
    get_function__EmergencyStop_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const dobot_msgs_v4::srv::EmergencyStop_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EmergencyStop_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_msgs_v4::srv::EmergencyStop_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(dobot_msgs_v4::srv::EmergencyStop_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(dobot_msgs_v4::srv::EmergencyStop_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EmergencyStop_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(dobot_msgs_v4::srv::EmergencyStop_Event),
  false,  // has_any_key_member_
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Event>()
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, EmergencyStop_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_Event_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers EmergencyStop_service_members = {
  ...
  // see get_service_type_support_handle<dobot_msgs_v4::srv::EmergencyStop>()
...
static const rosidl_service_type_support_t EmergencyStop_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<dobot_msgs_v4::srv::EmergencyStop>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<dobot_msgs_v4::srv::EmergencyStop>,
...
get_service_type_support_handle<dobot_msgs_v4::srv::EmergencyStop>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::dobot_msgs_v4::srv::rosidl_typesupport_introspection_cpp::EmergencyStop_service_type_support_handle;
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::dobot_msgs_v4::srv::EmergencyStop_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::dobot_msgs_v4::srv::EmergencyStop_Response
      >()->data
      );
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::dobot_msgs_v4::srv::EmergencyStop_Event
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, EmergencyStop)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<dobot_msgs_v4::srv::EmergencyStop>();
}

...
class Metaclass_DOGroup_Event(type):
    """Metaclass of message 'DOGroup_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__do_group__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__do_group__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__do_group__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__do_group__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__do_group__event
...
class DOGroup_Event(metaclass=Metaclass_DOGroup_Event):
    """Message class 'DOGroup_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/DOGroup_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/DOGroup_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'DOGroup_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'DOGroup_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import DOGroup_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DOGroup_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DOGroup_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import DOGroup_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DOGroup_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DOGroup_Response'"
...
class Metaclass_DOGroup(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v4.srv import _do_group
            ...
            if _do_group.Metaclass_DOGroup_Event._TYPE_SUPPORT is None:
                _do_group.Metaclass_DOGroup_Event.__import_type_support__()


class DOGroup(metaclass=Metaclass_DOGroup):
    from dobot_msgs_v4.srv._do_group import DOGroup_Request as Request
    from dobot_msgs_v4.srv._do_group import DOGroup_Response as Response
    from dobot_msgs_v4.srv._do_group import DOGroup_Event as Event

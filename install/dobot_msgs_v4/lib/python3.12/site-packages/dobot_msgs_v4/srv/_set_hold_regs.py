...
class Metaclass_SetHoldRegs_Event(type):
    """Metaclass of message 'SetHoldRegs_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_hold_regs__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_hold_regs__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_hold_regs__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_hold_regs__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_hold_regs__event
...
class SetHoldRegs_Event(metaclass=Metaclass_SetHoldRegs_Event):
    """Message class 'SetHoldRegs_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/SetHoldRegs_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/SetHoldRegs_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'SetHoldRegs_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'SetHoldRegs_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import SetHoldRegs_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetHoldRegs_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetHoldRegs_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import SetHoldRegs_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetHoldRegs_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetHoldRegs_Response'"
...
class Metaclass_SetHoldRegs(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v4.srv import _set_hold_regs
            ...
            if _set_hold_regs.Metaclass_SetHoldRegs_Event._TYPE_SUPPORT is None:
                _set_hold_regs.Metaclass_SetHoldRegs_Event.__import_type_support__()


class SetHoldRegs(metaclass=Metaclass_SetHoldRegs):
    from dobot_msgs_v4.srv._set_hold_regs import SetHoldRegs_Request as Request
    from dobot_msgs_v4.srv._set_hold_regs import SetHoldRegs_Response as Response
    from dobot_msgs_v4.srv._set_hold_regs import SetHoldRegs_Event as Event

...
class Metaclass_ModbusRTUCreate_Event(type):
    """Metaclass of message 'ModbusRTUCreate_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__modbus_rtu_create__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__modbus_rtu_create__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__modbus_rtu_create__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__modbus_rtu_create__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__modbus_rtu_create__event
...
class ModbusRTUCreate_Event(metaclass=Metaclass_ModbusRTUCreate_Event):
    """Message class 'ModbusRTUCreate_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/ModbusRTUCreate_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/ModbusRTUCreate_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'ModbusRTUCreate_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'ModbusRTUCreate_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import ModbusRTUCreate_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ModbusRTUCreate_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ModbusRTUCreate_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import ModbusRTUCreate_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ModbusRTUCreate_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ModbusRTUCreate_Response'"
...
class Metaclass_ModbusRTUCreate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _modbus_rtu_create.Metaclass_ModbusRTUCreate_Event._TYPE_SUPPORT is None:
                _modbus_rtu_create.Metaclass_ModbusRTUCreate_Event.__import_type_support__()
...
class ModbusRTUCreate(metaclass=Metaclass_ModbusRTUCreate):
    ...
    from dobot_msgs_v4.srv._modbus_rtu_create import ModbusRTUCreate_Event as Event

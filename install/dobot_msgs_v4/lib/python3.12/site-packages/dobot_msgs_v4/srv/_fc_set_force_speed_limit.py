...
class Metaclass_FCSetForceSpeedLimit_Event(type):
    """Metaclass of message 'FCSetForceSpeedLimit_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__fc_set_force_speed_limit__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__fc_set_force_speed_limit__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__fc_set_force_speed_limit__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__fc_set_force_speed_limit__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__fc_set_force_speed_limit__event
...
class FCSetForceSpeedLimit_Event(metaclass=Metaclass_FCSetForceSpeedLimit_Event):
    """Message class 'FCSetForceSpeedLimit_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/FCSetForceSpeedLimit_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/FCSetForceSpeedLimit_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'FCSetForceSpeedLimit_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'FCSetForceSpeedLimit_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import FCSetForceSpeedLimit_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, FCSetForceSpeedLimit_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'FCSetForceSpeedLimit_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import FCSetForceSpeedLimit_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, FCSetForceSpeedLimit_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'FCSetForceSpeedLimit_Response'"
...
class Metaclass_FCSetForceSpeedLimit(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _fc_set_force_speed_limit.Metaclass_FCSetForceSpeedLimit_Event._TYPE_SUPPORT is None:
                _fc_set_force_speed_limit.Metaclass_FCSetForceSpeedLimit_Event.__import_type_support__()
...
class FCSetForceSpeedLimit(metaclass=Metaclass_FCSetForceSpeedLimit):
    ...
    from dobot_msgs_v4.srv._fc_set_force_speed_limit import FCSetForceSpeedLimit_Event as Event

...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v4__srv__fc_force_mode__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._fc_force_mode.FCForceMode_Event", full_classname_dest, 50) == 0);
  }
  dobot_msgs_v4__srv__FCForceMode_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!dobot_msgs_v4__srv__FCForceMode_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dobot_msgs_v4__srv__FCForceMode_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dobot_msgs_v4__srv__FCForceMode_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dobot_msgs_v4__srv__fc_force_mode__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!dobot_msgs_v4__srv__FCForceMode_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dobot_msgs_v4__srv__FCForceMode_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dobot_msgs_v4__srv__FCForceMode_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dobot_msgs_v4__srv__fc_force_mode__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__fc_force_mode__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of FCForceMode_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._fc_force_mode");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FCForceMode_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  dobot_msgs_v4__srv__FCForceMode_Event * ros_message = (dobot_msgs_v4__srv__FCForceMode_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dobot_msgs_v4__srv__fc_force_mode__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dobot_msgs_v4__srv__fc_force_mode__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

...
class EmergencyStop_Event(metaclass=Metaclass_EmergencyStop_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/EmergencyStop_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/EmergencyStop_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'EmergencyStop_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'EmergencyStop_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import EmergencyStop_Request
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import EmergencyStop_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v4.srv.EmergencyStop')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_msgs_v4.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from dobot_msgs_v4.srv._emergency_stop import EmergencyStop_Request as Request
    from dobot_msgs_v4.srv._emergency_stop import EmergencyStop_Response as Response
    from dobot_msgs_v4.srv._emergency_stop import EmergencyStop_Event as Event

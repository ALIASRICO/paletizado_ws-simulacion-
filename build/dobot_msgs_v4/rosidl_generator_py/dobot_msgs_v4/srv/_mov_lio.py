...
class Metaclass_MovLIO_Event(type):
    """Metaclass of message 'MovLIO_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__mov_lio__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__mov_lio__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__mov_lio__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__mov_lio__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__mov_lio__event
...
class MovLIO_Event(metaclass=Metaclass_MovLIO_Event):
    """Message class 'MovLIO_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/MovLIO_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/MovLIO_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'MovLIO_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'MovLIO_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import MovLIO_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MovLIO_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MovLIO_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import MovLIO_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MovLIO_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MovLIO_Response'"
...
class Metaclass_MovLIO(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v4.srv import _mov_lio
            ...
            if _mov_lio.Metaclass_MovLIO_Event._TYPE_SUPPORT is None:
                _mov_lio.Metaclass_MovLIO_Event.__import_type_support__()


class MovLIO(metaclass=Metaclass_MovLIO):
    from dobot_msgs_v4.srv._mov_lio import MovLIO_Request as Request
    from dobot_msgs_v4.srv._mov_lio import MovLIO_Response as Response
    from dobot_msgs_v4.srv._mov_lio import MovLIO_Event as Event

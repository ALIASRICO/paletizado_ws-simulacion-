...
static const _SetSafeWallEnable_Request_type_support_symbol_names_t _SetSafeWallEnable_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetSafeWallEnable_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetSafeWallEnable_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetSafeWallEnable_Request)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetSafeWallEnable_Request_message_type_support_handle;
}
...
static const _SetSafeWallEnable_Response_type_support_symbol_names_t _SetSafeWallEnable_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetSafeWallEnable_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetSafeWallEnable_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetSafeWallEnable_Response)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetSafeWallEnable_Response_message_type_support_handle;
}
...
static const _SetSafeWallEnable_Event_type_support_symbol_names_t _SetSafeWallEnable_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetSafeWallEnable_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetSafeWallEnable_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetSafeWallEnable_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetSafeWallEnable_Event_message_type_support_handle;
}
...
static const _SetSafeWallEnable_type_support_symbol_names_t _SetSafeWallEnable_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetSafeWallEnable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetSafeWallEnable)),
  }
};
...
static const rosidl_service_type_support_t SetSafeWallEnable_service_type_support_handle = {
  ...
  &SetSafeWallEnable_Request_message_type_support_handle,
  &SetSafeWallEnable_Response_message_type_support_handle,
  &SetSafeWallEnable_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetSafeWallEnable)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetSafeWallEnable_service_type_support_handle;
}

...
#include "dobot_msgs_v4/srv/detail/set_back_distance__type_support.h"
...
static const _SetBackDistance_Request_type_support_symbol_names_t _SetBackDistance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetBackDistance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetBackDistance_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetBackDistance_Request)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetBackDistance_Request_message_type_support_handle;
}
...
static const _SetBackDistance_Response_type_support_symbol_names_t _SetBackDistance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetBackDistance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetBackDistance_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetBackDistance_Response)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetBackDistance_Response_message_type_support_handle;
}
...
typedef struct _SetBackDistance_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetBackDistance_Event_type_support_ids_t;

static const _SetBackDistance_Event_type_support_ids_t _SetBackDistance_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _SetBackDistance_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetBackDistance_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetBackDistance_Event_type_support_symbol_names_t _SetBackDistance_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetBackDistance_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetBackDistance_Event)),
  }
};

typedef struct _SetBackDistance_Event_type_support_data_t
{
  void * data[2];
} _SetBackDistance_Event_type_support_data_t;

static _SetBackDistance_Event_type_support_data_t _SetBackDistance_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetBackDistance_Event_message_typesupport_map = {
  2,
  "dobot_msgs_v4",
  &_SetBackDistance_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetBackDistance_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetBackDistance_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetBackDistance_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetBackDistance_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetBackDistance_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetBackDistance_Event_message_type_support_handle;
}
...
static const _SetBackDistance_type_support_symbol_names_t _SetBackDistance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetBackDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetBackDistance)),
  }
};
...
static const rosidl_service_type_support_t SetBackDistance_service_type_support_handle = {
  ...
  &SetBackDistance_Request_message_type_support_handle,
  &SetBackDistance_Response_message_type_support_handle,
  &SetBackDistance_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetBackDistance)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetBackDistance_service_type_support_handle;
}

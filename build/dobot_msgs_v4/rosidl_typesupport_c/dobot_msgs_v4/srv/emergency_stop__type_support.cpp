...
#include "dobot_msgs_v4/srv/detail/emergency_stop__type_support.h"
...
static const _EmergencyStop_Request_type_support_symbol_names_t _EmergencyStop_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, EmergencyStop_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, EmergencyStop_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, EmergencyStop_Request)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::EmergencyStop_Request_message_type_support_handle;
}
...
static const _EmergencyStop_Response_type_support_symbol_names_t _EmergencyStop_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, EmergencyStop_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, EmergencyStop_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, EmergencyStop_Response)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::EmergencyStop_Response_message_type_support_handle;
}
...
static const _EmergencyStop_Event_type_support_symbol_names_t _EmergencyStop_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, EmergencyStop_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, EmergencyStop_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, EmergencyStop_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::EmergencyStop_Event_message_type_support_handle;
}
...
static const _EmergencyStop_type_support_symbol_names_t _EmergencyStop_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, EmergencyStop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, EmergencyStop)),
  }
};
...
static const rosidl_service_type_support_t EmergencyStop_service_type_support_handle = {
  ...
  &EmergencyStop_Request_message_type_support_handle,
  &EmergencyStop_Response_message_type_support_handle,
  &EmergencyStop_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, EmergencyStop)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::EmergencyStop_service_type_support_handle;
}

...
static const _SetPayload_Request_type_support_symbol_names_t _SetPayload_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetPayload_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetPayload_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetPayload_Request)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetPayload_Request_message_type_support_handle;
}
...
static const _SetPayload_Response_type_support_symbol_names_t _SetPayload_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetPayload_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetPayload_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetPayload_Response)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetPayload_Response_message_type_support_handle;
}
...
static const _SetPayload_Event_type_support_symbol_names_t _SetPayload_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetPayload_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetPayload_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetPayload_Event)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetPayload_Event_message_type_support_handle;
}
...
static const _SetPayload_type_support_symbol_names_t _SetPayload_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, SetPayload)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v4, srv, SetPayload)),
  }
};
...
static const rosidl_service_type_support_t SetPayload_service_type_support_handle = {
  ...
  &SetPayload_Request_message_type_support_handle,
  &SetPayload_Response_message_type_support_handle,
  &SetPayload_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v4, srv, SetPayload)() {
  return &::dobot_msgs_v4::srv::rosidl_typesupport_c::SetPayload_service_type_support_handle;
}

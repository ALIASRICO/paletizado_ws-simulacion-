...
#include "dobot_msgs_v4/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs_v4::srv::EmergencyStop_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4::srv::EmergencyStop_Request & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4::srv::EmergencyStop_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v4::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v4::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, EmergencyStop_Request)() {
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs_v4
cdr_serialize(
  const dobot_msgs_v4::srv::EmergencyStop_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: res
  cdr << ros_message.res;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4::srv::EmergencyStop_Response & ros_message)
{
  // Member: res
  cdr >> ros_message.res;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v4::srv::EmergencyStop_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v4::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_msgs_v4::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, EmergencyStop_Response)() {
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
// functions for dobot_msgs_v4::srv::EmergencyStop_Request already declared above

// functions for dobot_msgs_v4::srv::EmergencyStop_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs_v4
cdr_serialize(
  const dobot_msgs_v4::srv::EmergencyStop_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4::srv::EmergencyStop_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dobot_msgs_v4::srv::typesupport_fastrtps_cpp::max_serialized_size_EmergencyStop_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dobot_msgs_v4::srv::typesupport_fastrtps_cpp::max_serialized_size_EmergencyStop_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v4::srv::EmergencyStop_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dobot_msgs_v4::srv::typesupport_fastrtps_cpp::max_serialized_size_key_EmergencyStop_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dobot_msgs_v4::srv::typesupport_fastrtps_cpp::max_serialized_size_key_EmergencyStop_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v4::srv::EmergencyStop_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_msgs_v4::srv::EmergencyStop_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, EmergencyStop_Event)() {
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop_Event__handle;
}
...
static const rosidl_service_type_support_t _EmergencyStop__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::EmergencyStop_Event>(),
...
{
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, EmergencyStop)() {
  return &dobot_msgs_v4::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}

...
#include "dobot_msgs_v4/msg/detail/tool_vector_actual__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs_v4::msg::ToolVectorActual & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4::msg::ToolVectorActual & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4::msg::ToolVectorActual;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs_v4
max_serialized_size_key_ToolVectorActual(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v4::msg::ToolVectorActual *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v4::msg::ToolVectorActual *>(
    untyped_ros_message);
...
{
  return &dobot_msgs_v4::msg::typesupport_fastrtps_cpp::_ToolVectorActual__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, msg, ToolVectorActual)() {
  return &dobot_msgs_v4::msg::typesupport_fastrtps_cpp::_ToolVectorActual__handle;
}

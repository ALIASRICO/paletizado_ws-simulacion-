...
#include "dobot_msgs_v4/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs_v4::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4::msg::RobotStatus & ros_message)
{
  // Member: is_enable
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v4::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v4::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &dobot_msgs_v4::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, msg, RobotStatus)() {
  return &dobot_msgs_v4::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}

...
class Init_ModbusRTUCreate_Event_response
{
public:
  explicit Init_ModbusRTUCreate_Event_response(::dobot_msgs_v4::srv::ModbusRTUCreate_Event & msg)
  : msg_(msg)
  {}
  ::dobot_msgs_v4::srv::ModbusRTUCreate_Event response(::dobot_msgs_v4::srv::ModbusRTUCreate_Event::_response_type arg)
  {
...
private:
  ::dobot_msgs_v4::srv::ModbusRTUCreate_Event msg_;
};

class Init_ModbusRTUCreate_Event_request
{
public:
  explicit Init_ModbusRTUCreate_Event_request(::dobot_msgs_v4::srv::ModbusRTUCreate_Event & msg)
  : msg_(msg)
  {}
  Init_ModbusRTUCreate_Event_response request(::dobot_msgs_v4::srv::ModbusRTUCreate_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_ModbusRTUCreate_Event_response(msg_);
  }
...
class Init_ModbusRTUCreate_Event_info
{
public:
  Init_ModbusRTUCreate_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ModbusRTUCreate_Event_request info(::dobot_msgs_v4::srv::ModbusRTUCreate_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_ModbusRTUCreate_Event_request(msg_);
  }
...
template<>
inline
auto build<::dobot_msgs_v4::srv::ModbusRTUCreate_Event>()
{
  return dobot_msgs_v4::srv::builder::Init_ModbusRTUCreate_Event_info();
}

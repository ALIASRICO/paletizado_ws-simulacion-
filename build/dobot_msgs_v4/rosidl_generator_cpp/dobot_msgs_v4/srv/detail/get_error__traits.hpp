...
inline std::string to_yaml(const GetError_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use dobot_msgs_v4::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dobot_msgs_v4::srv::GetError_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dobot_msgs_v4::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dobot_msgs_v4::srv::to_yaml() instead")]]
inline std::string to_yaml(const dobot_msgs_v4::srv::GetError_Event & msg)
{
  return dobot_msgs_v4::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dobot_msgs_v4::srv::GetError_Event>()
{
  return "dobot_msgs_v4::srv::GetError_Event";
}

template<>
inline const char * name<dobot_msgs_v4::srv::GetError_Event>()
{
  return "dobot_msgs_v4/srv/GetError_Event";
}

template<>
struct has_fixed_size<dobot_msgs_v4::srv::GetError_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dobot_msgs_v4::srv::GetError_Event>
  : std::integral_constant<bool, has_bounded_size<dobot_msgs_v4::srv::GetError_Request>::value && has_bounded_size<dobot_msgs_v4::srv::GetError_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dobot_msgs_v4::srv::GetError_Event>
  : std::true_type {};

...
class Metaclass_SetPayload_Event(type):
    """Metaclass of message 'SetPayload_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_payload__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_payload__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_payload__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_payload__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_payload__event
...
class SetPayload_Event(metaclass=Metaclass_SetPayload_Event):
    """Message class 'SetPayload_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/SetPayload_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/SetPayload_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'SetPayload_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'SetPayload_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import SetPayload_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetPayload_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetPayload_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import SetPayload_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPayload_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetPayload_Response'"
...
class Metaclass_SetPayload(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v4.srv import _set_payload
            ...
            if _set_payload.Metaclass_SetPayload_Event._TYPE_SUPPORT is None:
                _set_payload.Metaclass_SetPayload_Event.__import_type_support__()


class SetPayload(metaclass=Metaclass_SetPayload):
    from dobot_msgs_v4.srv._set_payload import SetPayload_Request as Request
    from dobot_msgs_v4.srv._set_payload import SetPayload_Response as Response
    from dobot_msgs_v4.srv._set_payload import SetPayload_Event as Event

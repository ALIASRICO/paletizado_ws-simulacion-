...
class Metaclass_ModbusCreate_Event(type):
    """Metaclass of message 'ModbusCreate_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__modbus_create__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__modbus_create__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__modbus_create__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__modbus_create__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__modbus_create__event
...
class ModbusCreate_Event(metaclass=Metaclass_ModbusCreate_Event):
    """Message class 'ModbusCreate_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dobot_msgs_v4/ModbusCreate_Request, 1>',
        'response': 'sequence<dobot_msgs_v4/ModbusCreate_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'ModbusCreate_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dobot_msgs_v4', 'srv'], 'ModbusCreate_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import ModbusCreate_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ModbusCreate_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ModbusCreate_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dobot_msgs_v4.srv import ModbusCreate_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ModbusCreate_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ModbusCreate_Response'"
...
class Metaclass_ModbusCreate(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v4.srv.ModbusCreate')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_msgs_v4.srv import _modbus_create
            ...
            if _modbus_create.Metaclass_ModbusCreate_Event._TYPE_SUPPORT is None:
                _modbus_create.Metaclass_ModbusCreate_Event.__import_type_support__()


class ModbusCreate(metaclass=Metaclass_ModbusCreate):
    from dobot_msgs_v4.srv._modbus_create import ModbusCreate_Request as Request
    from dobot_msgs_v4.srv._modbus_create import ModbusCreate_Response as Response
    from dobot_msgs_v4.srv._modbus_create import ModbusCreate_Event as Event

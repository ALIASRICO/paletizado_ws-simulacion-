...
bool dobot_msgs_v4__srv__circle__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._circle.Circle_Request", full_classname_dest, 40) == 0);
  }
  dobot_msgs_v4__srv__Circle_Request * ros_message = _ros_message;
  {  // mode
  ...
  {  // e2
    PyObject * field = PyObject_GetAttrString(_pymsg, "e2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->e2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // f2
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__circle__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Circle_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._circle");
  ...
  dobot_msgs_v4__srv__Circle_Request * ros_message = (dobot_msgs_v4__srv__Circle_Request *)raw_ros_message;
  {  // mode
    PyObject * field = NULL;
  ...
  {  // e2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->e2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "e2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v4__srv__circle__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._circle.Circle_Response", full_classname_dest, 41) == 0);
  }
  dobot_msgs_v4__srv__Circle_Response * ros_message = _ros_message;
  {  // res
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__circle__response__convert_to_py(void * raw_ros_message)
{
  ...
  dobot_msgs_v4__srv__Circle_Response * ros_message = (dobot_msgs_v4__srv__Circle_Response *)raw_ros_message;
  {  // res
    PyObject * field = NULL;
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v4__srv__circle__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v4.srv._circle.Circle_Event", full_classname_dest, 38) == 0);
  }
  dobot_msgs_v4__srv__Circle_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!dobot_msgs_v4__srv__Circle_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dobot_msgs_v4__srv__Circle_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dobot_msgs_v4__srv__Circle_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dobot_msgs_v4__srv__circle__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!dobot_msgs_v4__srv__Circle_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dobot_msgs_v4__srv__Circle_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dobot_msgs_v4__srv__Circle_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dobot_msgs_v4__srv__circle__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * dobot_msgs_v4__srv__circle__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Circle_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v4.srv._circle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Circle_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  dobot_msgs_v4__srv__Circle_Event * ros_message = (dobot_msgs_v4__srv__Circle_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dobot_msgs_v4__srv__circle__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dobot_msgs_v4__srv__circle__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

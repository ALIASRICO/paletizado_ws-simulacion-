...
class Metaclass_ToolVectorActual(type):
    """Metaclass of message 'ToolVectorActual'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__tool_vector_actual
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__tool_vector_actual
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__tool_vector_actual
            cls._TYPE_SUPPORT = module.type_support_msg__msg__tool_vector_actual
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__tool_vector_actual
...
class ToolVectorActual(metaclass=Metaclass_ToolVectorActual):
    """Message class 'ToolVectorActual'."""

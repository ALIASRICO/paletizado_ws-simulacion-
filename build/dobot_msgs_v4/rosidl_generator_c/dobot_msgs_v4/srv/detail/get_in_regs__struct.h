...
enum
{
  dobot_msgs_v4__srv__GetInRegs_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs_v4__srv__GetInRegs_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetInRegs in the package dobot_msgs_v4.
typedef struct dobot_msgs_v4__srv__GetInRegs_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs_v4__srv__GetInRegs_Request__Sequence request;
  dobot_msgs_v4__srv__GetInRegs_Response__Sequence response;
} dobot_msgs_v4__srv__GetInRegs_Event;

// Struct for a sequence of dobot_msgs_v4__srv__GetInRegs_Event.
typedef struct dobot_msgs_v4__srv__GetInRegs_Event__Sequence
{

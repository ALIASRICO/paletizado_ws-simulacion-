...
enum
{
  dobot_msgs_v4__srv__FCSetForceLimit_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs_v4__srv__FCSetForceLimit_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/FCSetForceLimit in the package dobot_msgs_v4.
typedef struct dobot_msgs_v4__srv__FCSetForceLimit_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs_v4__srv__FCSetForceLimit_Request__Sequence request;
  dobot_msgs_v4__srv__FCSetForceLimit_Response__Sequence response;
} dobot_msgs_v4__srv__FCSetForceLimit_Event;

// Struct for a sequence of dobot_msgs_v4__srv__FCSetForceLimit_Event.
typedef struct dobot_msgs_v4__srv__FCSetForceLimit_Event__Sequence
{

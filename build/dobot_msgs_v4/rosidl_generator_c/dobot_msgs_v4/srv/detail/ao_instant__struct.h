...
enum
{
  dobot_msgs_v4__srv__AOInstant_Event__request__MAX_SIZE = 1
};
// response
enum
{
  dobot_msgs_v4__srv__AOInstant_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AOInstant in the package dobot_msgs_v4.
typedef struct dobot_msgs_v4__srv__AOInstant_Event
{
  service_msgs__msg__ServiceEventInfo info;
  dobot_msgs_v4__srv__AOInstant_Request__Sequence request;
  dobot_msgs_v4__srv__AOInstant_Response__Sequence response;
} dobot_msgs_v4__srv__AOInstant_Event;

// Struct for a sequence of dobot_msgs_v4__srv__AOInstant_Event.
typedef struct dobot_msgs_v4__srv__AOInstant_Event__Sequence
{

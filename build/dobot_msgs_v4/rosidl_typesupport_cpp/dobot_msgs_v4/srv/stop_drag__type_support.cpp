...
static const _StopDrag_Request_type_support_symbol_names_t _StopDrag_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, StopDrag_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, StopDrag_Request)),
  }
};
...
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_cpp::StopDrag_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs_v4, srv, StopDrag_Request)() {
  return get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Request>();
}
...
static const _StopDrag_Response_type_support_symbol_names_t _StopDrag_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, StopDrag_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, StopDrag_Response)),
  }
};
...
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_cpp::StopDrag_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs_v4, srv, StopDrag_Response)() {
  return get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Response>();
}
...
static const _StopDrag_Event_type_support_symbol_names_t _StopDrag_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, StopDrag_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, StopDrag_Event)),
  }
};
...
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_cpp::StopDrag_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs_v4, srv, StopDrag_Event)() {
  return get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Event>();
}
...
static const _StopDrag_type_support_symbol_names_t _StopDrag_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, StopDrag)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, StopDrag)),
  }
};
...
static const rosidl_service_type_support_t StopDrag_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::StopDrag_Event>(),
...
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_cpp::StopDrag_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs_v4, srv, StopDrag)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<dobot_msgs_v4::srv::StopDrag>();
}

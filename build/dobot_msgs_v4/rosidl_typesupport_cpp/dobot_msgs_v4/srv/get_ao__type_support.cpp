...
static const _GetAO_Event_type_support_symbol_names_t _GetAO_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v4, srv, GetAO_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dobot_msgs_v4, srv, GetAO_Event)),
  }
};
...
{
  return &::dobot_msgs_v4::srv::rosidl_typesupport_cpp::GetAO_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dobot_msgs_v4, srv, GetAO_Event)() {
  return get_message_type_support_handle<dobot_msgs_v4::srv::GetAO_Event>();
}
...
static const rosidl_service_type_support_t GetAO_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::GetAO_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::GetAO_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dobot_msgs_v4::srv::GetAO_Event>(),

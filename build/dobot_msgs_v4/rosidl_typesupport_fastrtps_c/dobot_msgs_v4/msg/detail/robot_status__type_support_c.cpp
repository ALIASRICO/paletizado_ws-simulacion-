...
#include "dobot_msgs_v4/msg/detail/robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _RobotStatus__ros_msg_type = dobot_msgs_v4__msg__RobotStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
bool cdr_serialize_dobot_msgs_v4__msg__RobotStatus(
  const dobot_msgs_v4__msg__RobotStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
bool cdr_deserialize_dobot_msgs_v4__msg__RobotStatus(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v4__msg__RobotStatus * ros_message)
{
  // Field name: is_enable
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t get_serialized_size_dobot_msgs_v4__msg__RobotStatus(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t max_serialized_size_dobot_msgs_v4__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4__msg__RobotStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
bool cdr_serialize_key_dobot_msgs_v4__msg__RobotStatus(
  const dobot_msgs_v4__msg__RobotStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: is_enable
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t get_serialized_size_key_dobot_msgs_v4__msg__RobotStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotStatus__ros_msg_type * ros_message = static_cast<const _RobotStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t max_serialized_size_key_dobot_msgs_v4__msg__RobotStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dobot_msgs_v4__msg__RobotStatus * ros_message = static_cast<const dobot_msgs_v4__msg__RobotStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dobot_msgs_v4__msg__RobotStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dobot_msgs_v4__msg__RobotStatus * ros_message = static_cast<dobot_msgs_v4__msg__RobotStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dobot_msgs_v4__msg__RobotStatus(cdr, ros_message);
}

static uint32_t _RobotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v4__msg__RobotStatus(
...
static size_t _RobotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v4__msg__RobotStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, msg, RobotStatus)() {

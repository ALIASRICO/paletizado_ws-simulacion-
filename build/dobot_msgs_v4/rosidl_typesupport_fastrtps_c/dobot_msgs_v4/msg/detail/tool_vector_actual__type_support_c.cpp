...
#include "dobot_msgs_v4/msg/detail/tool_vector_actual__rosidl_typesupport_fastrtps_c.h"
...
using _ToolVectorActual__ros_msg_type = dobot_msgs_v4__msg__ToolVectorActual;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4__msg__ToolVectorActual;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const dobot_msgs_v4__msg__ToolVectorActual * ros_message = static_cast<const dobot_msgs_v4__msg__ToolVectorActual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_dobot_msgs_v4__msg__ToolVectorActual(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  dobot_msgs_v4__msg__ToolVectorActual * ros_message = static_cast<dobot_msgs_v4__msg__ToolVectorActual *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_dobot_msgs_v4__msg__ToolVectorActual(cdr, ros_message);
}

static uint32_t _ToolVectorActual__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v4__msg__ToolVectorActual(
...
static size_t _ToolVectorActual__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v4__msg__ToolVectorActual(
